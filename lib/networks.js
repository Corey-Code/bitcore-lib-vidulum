 ...
 * @param {Number} data.zaddr - The Vidulum payment address prefix. The same is in Vidulum
 * @param {Number} data.zkey - The Vidulum spending key prefix. The same is in Vidulum
...
addNetwork({
  ...
  zaddr: 0x169a,
  zkey: 0xab36,
  networkMagic: 0xdeadc001,
  port: 7676,
  dnsSeeds: [
    'explorer.vidulum.app',
    'explorer.vidulum.app'
  ]
});
