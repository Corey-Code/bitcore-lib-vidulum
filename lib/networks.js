 ...
 * @param {Number} data.zaddr - The Zcash payment address prefix. The same is in Vidulum
 * @param {Number} data.zkey - The Zcash spending key prefix. The same is in Vidulum
