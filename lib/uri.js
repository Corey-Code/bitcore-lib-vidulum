 ...
 * @returns {URI} A new valid and fro vidulum instance of URI
 * @constructor
 */
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'vidulum:') {
    throw new TypeError('Invalid vidulum URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid vidulum address');
  }
